// components/dashboard/CreateAbout.tsx
...
export default function CreateAbout({ onSuccess }: CreateAboutProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('image', selectedFile); // إضافة الملف مباشرة
  ...
  return (
    <div className="rounded-2xl shadow-lg p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold">Create New About Me</h2>
        <p className="text-gray-400">Put the information for the new about me</p>
      </div>
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <label
                htmlFor="image"
                className="cursor-pointer bg-background border border-gray-300 rounded-lg p-4 block transition-colors hover:bg-gray-50"
              >
              ...
              {selectedFile && (
                <div className="mt-2 p-2 bg-gray-100 rounded text-xs">
                  <p className="text-gray-600">The specified file</p>
                  <p className="text-gray-500 truncate">{selectedFile.name}</p>
                </div>
              )}
            </div>
          </div>
