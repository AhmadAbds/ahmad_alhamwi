...
export default function EditContact({ contact, onSuccess }: EditContactProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await contactService.updateContact(contact.id, formDataToSend);
      onSuccess();
    } catch (err) {
  ...
  return (
    <div className="rounded-2xl shadow-lg p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-400">Edit Contact</p>
      </div>
