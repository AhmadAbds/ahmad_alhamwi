...
interface CreateAchieveProps {
  onSuccess: () => void;
}

export default function CreateAchievements({ onSuccess }: CreateAchieveProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await achievementsService.createachievements(formData);
      
      console.log('✅ تم إنشاء  بنجاح');
      setMessage('تم إنشاء  بنجاح');
  ...
  return (
    <div className="rounded-2xl shadow-lg p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold">Create New Achievement</h2>
        <p className="text-gray-400">Put the information for the new achievement</p>
      </div>
