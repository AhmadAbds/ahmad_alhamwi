...
interface CreateClassiProps {
  onSuccess: () => void;
} 

export default function CreateClassification({ onSuccess }: CreateClassiProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await classificationService.createClassification(formData);
  ...
  return (
    <div className="rounded-2xl shadow-lg p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold">Create New classification</h2>
        <p className="text-gray-400">Put the information for the new classification</p>
      </div>
